...
if __name__ == '__main__':
    if 'feng_homogenous' in sys.argv:
        ...
        network_dir = network_dir + '_homogenous_1000'
...
edge_params = {
    ...
    'THALAMUS2CR': {
        ...
        'distance_range': [0.0, 9999.9],
        'dynamics_params': 'tone2PN_A.json'
    },
    'TONE2PN_C': {
        'connection_rule': background_tone_connector,
        ...
        'target_sections': ['apical'],
        'distance_range': [0.0, 9999.9],
        'dynamics_params': 'tone2PN_C.json'
    },
    'TONE2PV': {
        'connection_rule': background_tone_connector,
        'connection_params': {'offset': numPN_A + numPN_C},
...
build_env_bionet(base_dir='./',
	...
	report_vars = ['v'],
        v_init = -70.0,
        celsius = 31.0,
	spikes_inputs=[('thalamus_pyr','thalamus_pyr_spikes.h5'),
                    ('thalamus_pv','thalamus_pv_spikes.h5'),
                    ('thalamus_som','thalamus_som_spikes.h5'),
                    ('tone','tone_spikes_baseline.h5')],
