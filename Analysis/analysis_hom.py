...
def ecp_psd(ecp,skip_n=0,downsample=10,nfft=1024,fs=1000,noverlap=0,ax=None):
    ...
    #f,pxx = welch(data,fs,noverlap=noverlap,nfft=nfft)
...
def run(show_plots=False,save_plots=False,slack=True):
    ...
    if show_plots or save_plots:
        ...
        fig.suptitle('Amygdala Gamma Analysis')
