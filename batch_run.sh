...
{ printf "Start: $START \nEnd:   $END\n" & python analysis.py --save-plots & printf "\n\n" & git diff components/synaptic_models/; }| mail -r gregglickert@mail.missouri.edu -s "AmygdalaTheta Simulation Results" -a analysis.png gregglickert@mail.missouri.edu
