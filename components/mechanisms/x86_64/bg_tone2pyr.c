...
#define nrn_init _nrn_init__bg_tone2pyr
#define _nrn_initial _nrn_initial__bg_tone2pyr
#define nrn_cur _nrn_cur__bg_tone2pyr
#define _nrn_current _nrn_current__bg_tone2pyr
#define nrn_jacob _nrn_jacob__bg_tone2pyr
#define nrn_state _nrn_state__bg_tone2pyr
#define _net_receive _net_receive__bg_tone2pyr 
#define release release__bg_tone2pyr 
...
#define eta eta_bg_tone2pyr
#define omega omega_bg_tone2pyr
#define sfunc sfunc_bg_tone2pyr
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 bg_tone2pyr /home/gjgpb9/LargeScaleBLA/components/mechanisms/x86_64/bg_tone2pyr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gjgpb9/LargeScaleBLA/components/mechanisms/modfiles/bg_tone2pyr.mod";
static const char* nmodl_file_text = 
  ":Tone to Pyramidal Cells AMPA+NMDA with local Ca2+ pool\n"
  ":No different from tone2pyr synapse just used to easily separate bg from tone trials\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS bg_tone2pyr\n"
  "	USEION ca READ eca	\n"
