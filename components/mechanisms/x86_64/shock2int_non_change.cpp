...
#define nrn_init _nrn_init__shock2int_non_change
#define _nrn_initial _nrn_initial__shock2int_non_change
#define nrn_cur _nrn_cur__shock2int_non_change
#define _nrn_current _nrn_current__shock2int_non_change
#define nrn_jacob _nrn_jacob__shock2int_non_change
#define nrn_state _nrn_state__shock2int_non_change
#define _net_receive _net_receive__shock2int_non_change 
#define release release__shock2int_non_change 
...
#define DA2 DA2_shock2int_non_change
#define DA1 DA1_shock2int_non_change
#define GAP1 GAP1_shock2int_non_change
#define NE2 NE2_shock2int_non_change
#define NEn NEn_shock2int_non_change
#define eta eta_shock2int_non_change
#define omega omega_shock2int_non_change
#define unirand unirand_shock2int_non_change
...
#define Beta2 Beta2_shock2int_non_change
 double Beta2 = 0.0001;
#define Beta1 Beta1_shock2int_non_change
 double Beta1 = 0.001;
#define DA_S DA_S_shock2int_non_change
 double DA_S = 1.6;
#define DA_t3 DA_t3_shock2int_non_change
 double DA_t3 = 1.25;
#define DA_t2 DA_t2_shock2int_non_change
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_shock2int_non_change
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_shock2int_non_change
 double DAstop2 = 36000;
#define DAstart2 DAstart2_shock2int_non_change
 double DAstart2 = 35900;
#define DAstop1 DAstop1_shock2int_non_change
 double DAstop1 = 40000;
#define DAstart1 DAstart1_shock2int_non_change
 double DAstart1 = 39500;
#define GAPstop1 GAPstop1_shock2int_non_change
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_shock2int_non_change
 double GAPstart1 = 96000;
#define NE_S NE_S_shock2int_non_change
 double NE_S = 1;
#define NE_t3 NE_t3_shock2int_non_change
 double NE_t3 = 1;
#define NE_t2 NE_t2_shock2int_non_change
 double NE_t2 = 1;
#define NE_t1 NE_t1_shock2int_non_change
 double NE_t1 = 1;
#define NEstop2 NEstop2_shock2int_non_change
 double NEstop2 = 36000;
#define NEstart2 NEstart2_shock2int_non_change
 double NEstart2 = 35900;
#define NEstop1 NEstop1_shock2int_non_change
 double NEstop1 = 40000;
#define NEstart1 NEstart1_shock2int_non_change
 double NEstart1 = 39500;
#define k k_shock2int_non_change
 double k = 0.01;
 ...
 {"Beta1_shock2int_non_change", "/ms"},
 {"Beta2_shock2int_non_change", "/ms"},
 {"srcid", "1"},
 {"destid", "1"},
 {"Cdur_gaba", "ms"},
 {"AlphaTmax_gaba", "/ms"},
 ...
 {"k_shock2int_non_change", &k_shock2int_non_change},
 {"GAPstart1_shock2int_non_change", &GAPstart1_shock2int_non_change},
 {"GAPstop1_shock2int_non_change", &GAPstop1_shock2int_non_change},
 {"DAstart1_shock2int_non_change", &DAstart1_shock2int_non_change},
 {"DAstop1_shock2int_non_change", &DAstop1_shock2int_non_change},
 {"DAstart2_shock2int_non_change", &DAstart2_shock2int_non_change},
 {"DAstop2_shock2int_non_change", &DAstop2_shock2int_non_change},
 {"DA_t1_shock2int_non_change", &DA_t1_shock2int_non_change},
 {"DA_t2_shock2int_non_change", &DA_t2_shock2int_non_change},
 {"DA_t3_shock2int_non_change", &DA_t3_shock2int_non_change},
 {"DA_S_shock2int_non_change", &DA_S_shock2int_non_change},
 {"Beta1_shock2int_non_change", &Beta1_shock2int_non_change},
 {"Beta2_shock2int_non_change", &Beta2_shock2int_non_change},
 {"NEstart1_shock2int_non_change", &NEstart1_shock2int_non_change},
 {"NEstop1_shock2int_non_change", &NEstop1_shock2int_non_change},
 {"NEstart2_shock2int_non_change", &NEstart2_shock2int_non_change},
 {"NEstop2_shock2int_non_change", &NEstop2_shock2int_non_change},
 {"NE_t1_shock2int_non_change", &NE_t1_shock2int_non_change},
 {"NE_t2_shock2int_non_change", &NE_t2_shock2int_non_change},
 {"NE_t3_shock2int_non_change", &NE_t3_shock2int_non_change},
 {"NE_S_shock2int_non_change", &NE_S_shock2int_non_change},
 {0, 0}
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _shock2int_non_change_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 shock2int_non_change /home/gjgpb9/LargeScaleBLA_work_in_pro/components/mechanisms/modfiles_core/shock2int_non_change.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/gjgpb9/LargeScaleBLA_work_in_pro/components/mechanisms/modfiles_core/shock2int_non_change.mod";
    const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS shock2int_non_change\n"
