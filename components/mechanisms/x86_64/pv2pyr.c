...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pv2pyr /home/gglick9/LargeScaleBLA/components/mechanisms/modfiles/pv2pyr.mod\n");
...
static void _initlists() {
 ...
 _slist1[2] = r_gaba_columnindex;  _dlist1[2] = Dr_gaba_columnindex;
 _slist1[3] = capoolcon_columnindex;  _dlist1[3] = Dcapoolcon_columnindex;
_first = 0;
}

#if NMODL_TEXT
static const char* nmodl_filename = "/home/gglick9/LargeScaleBLA/components/mechanisms/modfiles/pv2pyr.mod";
static const char* nmodl_file_text = 
