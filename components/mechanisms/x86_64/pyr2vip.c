...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyr2vip /home/gglick9/LargeScaleBLA/components/mechanisms/modfiles/pyr2vip.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 163 in file pyr2vip.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gglick9/LargeScaleBLA/components/mechanisms/modfiles/pyr2vip.mod";
static const char* nmodl_file_text = 
