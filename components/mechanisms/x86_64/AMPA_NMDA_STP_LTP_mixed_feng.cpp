...
#define nrn_init _nrn_init__AMPA_NMDA_STP_LTP_mixed_feng
#define _nrn_initial _nrn_initial__AMPA_NMDA_STP_LTP_mixed_feng
#define nrn_cur _nrn_cur__AMPA_NMDA_STP_LTP_mixed_feng
#define _nrn_current _nrn_current__AMPA_NMDA_STP_LTP_mixed_feng
#define nrn_jacob _nrn_jacob__AMPA_NMDA_STP_LTP_mixed_feng
#define nrn_state _nrn_state__AMPA_NMDA_STP_LTP_mixed_feng
#define _net_receive _net_receive__AMPA_NMDA_STP_LTP_mixed_feng 
#define state state__AMPA_NMDA_STP_LTP_mixed_feng 
...
#define A_AMPA _p[56]
#define A_AMPA_columnindex 56
#define B_AMPA _p[57]
#define B_AMPA_columnindex 57
#define gmax_AMPA _p[58]
#define gmax_AMPA_columnindex 58
#define A_NMDA _p[59]
#define A_NMDA_columnindex 59
#define B_NMDA _p[60]
#define B_NMDA_columnindex 60
#define Use_TM _p[61]
#define Use_TM_columnindex 61
#define m_VDCC _p[62]
#define m_VDCC_columnindex 62
#define h_VDCC _p[63]
#define h_VDCC_columnindex 63
#define cai_CR _p[64]
#define cai_CR_columnindex 64
#define rho_GB _p[65]
#define rho_GB_columnindex 65
#define effcai_GB _p[66]
#define effcai_GB_columnindex 66
#define W _p[67]
#define W_columnindex 67
#define rng_TM _p[68]
#define rng_TM_columnindex 68
#define usingR123 _p[69]
#define usingR123_columnindex 69
#define DA_AMPA _p[70]
#define DA_AMPA_columnindex 70
#define DB_AMPA _p[71]
#define DB_AMPA_columnindex 71
#define Dgmax_AMPA _p[72]
#define Dgmax_AMPA_columnindex 72
#define DA_NMDA _p[73]
#define DA_NMDA_columnindex 73
#define DB_NMDA _p[74]
#define DB_NMDA_columnindex 74
#define DUse_TM _p[75]
#define DUse_TM_columnindex 75
#define Dm_VDCC _p[76]
#define Dm_VDCC_columnindex 76
#define Dh_VDCC _p[77]
#define Dh_VDCC_columnindex 77
#define Dcai_CR _p[78]
#define Dcai_CR_columnindex 78
#define Drho_GB _p[79]
#define Drho_GB_columnindex 79
#define Deffcai_GB _p[80]
#define Deffcai_GB_columnindex 80
#define DW _p[81]
#define DW_columnindex 81
#define v _p[82]
#define v_columnindex 82
#define _g _p[83]
#define _g_columnindex 83
#define _tsav _p[84]
#define _tsav_columnindex 84
...
#define brand brand_AMPA_NMDA_STP_LTP_mixed_feng
#define eta eta_AMPA_NMDA_STP_LTP_mixed_feng
#define nernst nernst_AMPA_NMDA_STP_LTP_mixed_feng
#define omega omega_AMPA_NMDA_STP_LTP_mixed_feng
#define urand urand_AMPA_NMDA_STP_LTP_mixed_feng
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _AMPA_NMDA_STP_LTP_mixed_feng_reg() {
	int _vectorized = 1;
  _initlists();
...
#endif
  hoc_register_prop_size(_mechtype, 85, 9);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 AMPA_NMDA_STP_LTP_mixed_feng /home/gjgpb9/LargeScaleBLA_work_in_pro/components/mechanisms/modfiles_core/AMPA_NMDA_STP_LTP_mixed_feng.mod\n");
...
static int state (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset=0; int error = 0;
 {
  ...
  auto* _dlist2 = _thread[_dith1].get<double*>() + 11;
  int _counte = -1;
 if (!_recurse) {
 _recurse = 1;
 {int _id; for(_id=0; _id < 11; _id++) { _savstate1[_id] = _p[_slist1[_id]];}}
 error = nrn_newton_thread(_newtonspace1, 11,_slist2, _p, state, _dlist2, _p, _ppvar, _thread, _nt);
...
{
 {  _deriv1_advance = 1;
 derivimplicit_thread(11, _slist1, _dlist1, _p, state, _p, _ppvar, _thread, _nt);
_deriv1_advance = 0;
     if (secondorder) {
    int _i;
    for (_i = 0; _i < 11; ++_i) {
...
static void _initlists(){
 ...
 _slist1[4] = Use_TM_columnindex;  _dlist1[4] = DUse_TM_columnindex;
 _slist1[5] = m_VDCC_columnindex;  _dlist1[5] = Dm_VDCC_columnindex;
 _slist1[6] = h_VDCC_columnindex;  _dlist1[6] = Dh_VDCC_columnindex;
 _slist1[7] = cai_CR_columnindex;  _dlist1[7] = Dcai_CR_columnindex;
 _slist1[8] = effcai_GB_columnindex;  _dlist1[8] = Deffcai_GB_columnindex;
 _slist1[9] = rho_GB_columnindex;  _dlist1[9] = Drho_GB_columnindex;
 _slist1[10] = W_columnindex;  _dlist1[10] = DW_columnindex;
 ...
 _slist2[5] = W_columnindex;
 _slist2[6] = cai_CR_columnindex;
 _slist2[7] = effcai_GB_columnindex;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/gjgpb9/LargeScaleBLA_work_in_pro/components/mechanisms/modfiles_core/AMPA_NMDA_STP_LTP_mixed_feng.mod";
  ...
  "NEURON {\n"
  "    THREADSAFE\n"
  "    POINT_PROCESS AMPA_NMDA_STP_LTP_mixed_feng\n"
  ...
  "    RANGE lambda1, lambda2, W, limitW : added by Greg Glickert\n"
  ...
  "    :W' = 1e-12*limitW*eta(effcai_GB)*(lambda1*omega(effcai_GB, theta_d_GB, theta_p_GB)-lambda2*W)	  : Long-term plasticity was implemented. (Shouval et al. 2002a, 2002b)\n"
  "}\n"
  "\n"
