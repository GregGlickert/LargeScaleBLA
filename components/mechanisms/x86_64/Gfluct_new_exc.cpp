...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _Gfluct_new_exc_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 Gfluct2_exc /home/gjgpb9/LargeScaleBLA_work_in_pro/components/mechanisms/modfiles_core/Gfluct_new_exc.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/gjgpb9/LargeScaleBLA_work_in_pro/components/mechanisms/modfiles_core/Gfluct_new_exc.mod";
