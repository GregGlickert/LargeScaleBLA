...
#define nrn_init _nrn_init__som2vip
#define _nrn_initial _nrn_initial__som2vip
#define nrn_cur _nrn_cur__som2vip
#define _nrn_current _nrn_current__som2vip
#define nrn_jacob _nrn_jacob__som2vip
#define nrn_state _nrn_state__som2vip
#define _net_receive _net_receive__som2vip 
#define release release__som2vip 
...
#define DA2 DA2_som2vip
#define DA1 DA1_som2vip
#define GAP1 GAP1_som2vip
#define NE2 NE2_som2vip
#define NEn NEn_som2vip
#define eta eta_som2vip
#define omega omega_som2vip
#define unirand unirand_som2vip
...
#define Beta2 Beta2_som2vip
 double Beta2 = 0.0001;
#define Beta1 Beta1_som2vip
 double Beta1 = 0.001;
#define DA_S DA_S_som2vip
 double DA_S = 1.6;
#define DA_t3 DA_t3_som2vip
 double DA_t3 = 1.25;
#define DA_t2 DA_t2_som2vip
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_som2vip
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_som2vip
 double DAstop2 = 36000;
#define DAstart2 DAstart2_som2vip
 double DAstart2 = 35900;
#define DAstop1 DAstop1_som2vip
 double DAstop1 = 40000;
#define DAstart1 DAstart1_som2vip
 double DAstart1 = 39500;
#define GAPstop1 GAPstop1_som2vip
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_som2vip
 double GAPstart1 = 96000;
#define NE_S NE_S_som2vip
 double NE_S = 1;
#define NE_t3 NE_t3_som2vip
 double NE_t3 = 1;
#define NE_t2 NE_t2_som2vip
 double NE_t2 = 1;
#define NE_t1 NE_t1_som2vip
 double NE_t1 = 1;
#define NEstop2 NEstop2_som2vip
 double NEstop2 = 36000;
#define NEstart2 NEstart2_som2vip
 double NEstart2 = 35900;
#define NEstop1 NEstop1_som2vip
 double NEstop1 = 40000;
#define NEstart1 NEstart1_som2vip
...
#define k k_som2vip
 ...
 "k_som2vip", &k_som2vip,
 "GAPstart1_som2vip", &GAPstart1_som2vip,
 "GAPstop1_som2vip", &GAPstop1_som2vip,
 "DAstart1_som2vip", &DAstart1_som2vip,
 "DAstop1_som2vip", &DAstop1_som2vip,
 "DAstart2_som2vip", &DAstart2_som2vip,
 "DAstop2_som2vip", &DAstop2_som2vip,
 "DA_t1_som2vip", &DA_t1_som2vip,
 "DA_t2_som2vip", &DA_t2_som2vip,
 "DA_t3_som2vip", &DA_t3_som2vip,
 "DA_S_som2vip", &DA_S_som2vip,
 "Beta1_som2vip", &Beta1_som2vip,
 "Beta2_som2vip", &Beta2_som2vip,
 "NEstart1_som2vip", &NEstart1_som2vip,
 "NEstop1_som2vip", &NEstop1_som2vip,
 "NEstart2_som2vip", &NEstart2_som2vip,
 "NEstop2_som2vip", &NEstop2_som2vip,
 "NE_t1_som2vip", &NE_t1_som2vip,
 "NE_t2_som2vip", &NE_t2_som2vip,
 "NE_t3_som2vip", &NE_t3_som2vip,
 "NE_S_som2vip", &NE_S_som2vip,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 som2vip /home/gglick9/LargeScaleBLA/components/mechanisms/modfiles/som2vip.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 185 in file som2vip.mod:\n	 \n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gglick9/LargeScaleBLA/components/mechanisms/modfiles/som2vip.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  ":SAME AS som2pv synapse\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS som2vip\n"
