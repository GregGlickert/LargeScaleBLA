...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 Gfluct2_exc /home/gjgpb9/LargeScaleBLA/components/mechanisms/x86_64/Gfluct_new_exc.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gjgpb9/LargeScaleBLA/components/mechanisms/modfiles/Gfluct_new_exc.mod";
static const char* nmodl_file_text = 
