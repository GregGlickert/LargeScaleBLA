...
#define nrn_init _nrn_init__vip2som
#define _nrn_initial _nrn_initial__vip2som
#define nrn_cur _nrn_cur__vip2som
#define _nrn_current _nrn_current__vip2som
#define nrn_jacob _nrn_jacob__vip2som
#define nrn_state _nrn_state__vip2som
#define _net_receive _net_receive__vip2som 
#define release release__vip2som 
...
#define DA2 DA2_vip2som
#define DA1 DA1_vip2som
#define GAP1 GAP1_vip2som
#define NE2 NE2_vip2som
#define NEn NEn_vip2som
#define eta eta_vip2som
#define omega omega_vip2som
#define unirand unirand_vip2som
...
#define Beta2 Beta2_vip2som
 double Beta2 = 0.0001;
#define Beta1 Beta1_vip2som
 double Beta1 = 0.001;
#define DA_S DA_S_vip2som
 double DA_S = 1.6;
#define DA_t3 DA_t3_vip2som
 double DA_t3 = 1.25;
#define DA_t2 DA_t2_vip2som
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_vip2som
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_vip2som
 double DAstop2 = 36000;
#define DAstart2 DAstart2_vip2som
 double DAstart2 = 35900;
#define DAstop1 DAstop1_vip2som
 double DAstop1 = 40000;
#define DAstart1 DAstart1_vip2som
 double DAstart1 = 39500;
#define GAPstop1 GAPstop1_vip2som
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_vip2som
 double GAPstart1 = 96000;
#define NE_S NE_S_vip2som
 double NE_S = 1;
#define NE_t3 NE_t3_vip2som
 double NE_t3 = 1;
#define NE_t2 NE_t2_vip2som
 double NE_t2 = 1;
#define NE_t1 NE_t1_vip2som
 double NE_t1 = 1;
#define NEstop2 NEstop2_vip2som
 double NEstop2 = 36000;
#define NEstart2 NEstart2_vip2som
 double NEstart2 = 35900;
#define NEstop1 NEstop1_vip2som
 double NEstop1 = 40000;
#define NEstart1 NEstart1_vip2som
...
#define k k_vip2som
 ...
 "k_vip2som", &k_vip2som,
 "GAPstart1_vip2som", &GAPstart1_vip2som,
 "GAPstop1_vip2som", &GAPstop1_vip2som,
 "DAstart1_vip2som", &DAstart1_vip2som,
 "DAstop1_vip2som", &DAstop1_vip2som,
 "DAstart2_vip2som", &DAstart2_vip2som,
 "DAstop2_vip2som", &DAstop2_vip2som,
 "DA_t1_vip2som", &DA_t1_vip2som,
 "DA_t2_vip2som", &DA_t2_vip2som,
 "DA_t3_vip2som", &DA_t3_vip2som,
 "DA_S_vip2som", &DA_S_vip2som,
 "Beta1_vip2som", &Beta1_vip2som,
 "Beta2_vip2som", &Beta2_vip2som,
 "NEstart1_vip2som", &NEstart1_vip2som,
 "NEstop1_vip2som", &NEstop1_vip2som,
 "NEstart2_vip2som", &NEstart2_vip2som,
 "NEstop2_vip2som", &NEstop2_vip2som,
 "NE_t1_vip2som", &NE_t1_vip2som,
 "NE_t2_vip2som", &NE_t2_vip2som,
 "NE_t3_vip2som", &NE_t3_vip2som,
 "NE_S_vip2som", &NE_S_vip2som,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 vip2som /home/gglick9/LargeScaleBLA/components/mechanisms/modfiles/vip2som.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 185 in file vip2som.mod:\n	 \n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gglick9/LargeScaleBLA/components/mechanisms/modfiles/vip2som.mod";
static const char* nmodl_file_text = 
  ":Interneuron Cells to Pyramidal Cells GABA with local Ca2+ pool and read public soma Ca2+ pool\n"
  ":NON-Plastic\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS vip2som\n"
