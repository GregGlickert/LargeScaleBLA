...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _AMPA_NMDA_STP_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 pnt_receive_size[_mechtype] = 8;
 	...
 	ivoc_help("help ?1 AMPA_NMDA_STP /home/gjgpb9/LargeScaleBLA_work_in_pro/components/mechanisms/modfiles_core/AMPA_NMDA_STP.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/gjgpb9/LargeScaleBLA_work_in_pro/components/mechanisms/modfiles_core/AMPA_NMDA_STP.mod";
